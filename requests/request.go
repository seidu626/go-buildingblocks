...
type Request struct {
	...
	Resp    Response        // Struct for save the response
...
func ParallelRequest(reqs []Request, N int) []Response {
	var wg sync.WaitGroup
	var results = make([]Response, len(reqs))
...
func (req *Request) ExecuteRequest(client *http.Client) Response {
...
func (req *Request) SendRequest(url, method string, bodyData []byte, headers []string, skipTLS bool, timeout time.Duration) *Response {
